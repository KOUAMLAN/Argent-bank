...
export const MoneyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M7 18c-1.1 0-2 .9-2 2h14c0-1.1-.9-2-2-2H7zM19 3H5c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-1 8h-2v2h-2v-2H8v-2h2V7h2v2h2v2z"/>
    </svg>
);
